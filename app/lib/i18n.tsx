...
const rows: Row[] = [
  ...
  ["Parameter help:", "Ayuda del parámetro:", "Aide du paramètre :", "參數說明：", "पैरामीटर सहायता:", "مساعدة المعلمة:"],
  ["ACCESSIBILITY", "ACCESIBILIDAD", "ACCESSIBILITÉ", "無障礙", "सुलभता", "إمكانية الوصول"],
  ["Display and motion", "Visualización y movimiento", "Affichage et mouvement", "顯示及動態效果", "डिस्प्ले और गति", "العرض والحركة"],
  ["Choose the reading preferences that work best for you. Settings are saved on this device.", "Elige las preferencias de lectura que mejor te funcionen. La configuración se guarda en este dispositivo.", "Choisissez les préférences de lecture qui vous conviennent. Les réglages sont enregistrés sur cet appareil.", "選擇最適合你的閱讀設定；設定會儲存在此裝置。", "अपने लिए उपयुक्त पढ़ने की प्राथमिकताएँ चुनें। सेटिंग इस डिवाइस पर सहेजी जाती हैं।", "اختر تفضيلات القراءة الأنسب لك. تُحفظ الإعدادات على هذا الجهاز."],
  ["Larger text", "Texto más grande", "Texte agrandi", "較大文字", "बड़ा टेक्स्ट", "نص أكبر"],
  ["Increase text throughout every application tab.", "Aumenta el texto en todas las pestañas de la aplicación.", "Agrandit le texte dans tous les onglets de l’application.", "放大應用程式所有分頁的文字。", "ऐप के हर टैब में टेक्स्ट बड़ा करें।", "تكبير النص في جميع علامات تبويب التطبيق."],
  ["Enhanced contrast", "Contraste mejorado", "Contraste renforcé", "增強對比度", "बेहतर कंट्रास्ट", "تباين محسّن"],
  ["Strengthen text, borders, controls, and focus indicators.", "Refuerza el texto, los bordes, los controles y los indicadores de enfoque.", "Renforce le texte, les bordures, les commandes et les indicateurs de focus.", "加強文字、邊框、控制項及焦點標示。", "टेक्स्ट, बॉर्डर, कंट्रोल और फ़ोकस संकेत अधिक स्पष्ट करें।", "تعزيز النص والحدود وعناصر التحكم ومؤشرات التركيز."],
  ["Reduce motion", "Reducir movimiento", "Réduire les animations", "減少動態效果", "गतिशीलता कम करें", "تقليل الحركة"],
  ["Pause the structural animation and remove decorative movement.", "Pausa la animación estructural y elimina el movimiento decorativo.", "Met en pause l’animation structurelle et supprime les mouvements décoratifs.", "暫停結構動畫並移除裝飾性動態效果。", "संरचनात्मक एनीमेशन रोकें और सजावटी गति हटाएँ।", "إيقاف الحركة الإنشائية وإزالة الحركة الزخرفية."],
  ["Hearing and screen-reader access", "Acceso auditivo y para lectores de pantalla", "Accès auditif et lecteurs d’écran", "聽覺及螢幕閱讀器支援", "श्रवण और स्क्रीन रीडर पहुँच", "دعم السمع وقارئات الشاشة"],
  ["Alerts and simulation results are presented as text and visuals; no audio is required. Keyboard navigation, descriptive labels, and live status messages are available throughout the app.", "Las alertas y los resultados de la simulación se presentan como texto y elementos visuales; no se requiere audio. La navegación por teclado, las etiquetas descriptivas y los mensajes de estado están disponibles en toda la aplicación.", "Les alertes et les résultats sont présentés sous forme de texte et de visuels ; aucun son n’est requis. La navigation au clavier, les libellés descriptifs et les messages d’état sont disponibles dans toute l’application.", "警報及模擬結果均以文字和視覺方式呈現，毋須音訊。整個應用程式均支援鍵盤導覽、描述標籤及即時狀態訊息。", "अलर्ट और सिमुलेशन परिणाम टेक्स्ट व दृश्य रूप में दिए जाते हैं; ऑडियो आवश्यक नहीं है। पूरे ऐप में कीबोर्ड नेविगेशन, वर्णनात्मक लेबल और लाइव स्थिति संदेश उपलब्ध हैं।", "تُعرض التنبيهات ونتائج المحاكاة كنصوص وعناصر مرئية ولا يلزم الصوت. يتوفر التنقل بلوحة المفاتيح والتسميات الوصفية ورسائل الحالة المباشرة في جميع أنحاء التطبيق."],
  ["HOUSEHOLD PREPAREDNESS", "PREPARACIÓN DEL HOGAR", "PRÉPARATION DU FOYER", "家居應急準備", "घरेलू तैयारी", "استعداد المنزل"],
  ["Emergency kit checklist", "Lista del kit de emergencia", "Liste du kit d’urgence", "應急用品清單", "आपातकालीन किट सूची", "قائمة حقيبة الطوارئ"],
  ["Build a practical supply kit for disasters and outages. Your progress is saved on this device so you can prepare over time.", "Prepara un kit práctico para desastres y cortes de servicios. Tu progreso se guarda en este dispositivo para que puedas prepararte poco a poco.", "Préparez un kit pratique pour les catastrophes et les coupures. Votre progression est enregistrée sur cet appareil.", "準備一套適用於災害及停電的實用物資；進度會儲存在此裝置，方便逐步完成。", "आपदाओं और सेवाएँ बंद होने की स्थिति के लिए उपयोगी किट बनाएँ। आपकी प्रगति इस डिवाइस पर सहेजी जाती है।", "جهّز حقيبة عملية للكوارث وانقطاع الخدمات. يُحفظ تقدمك على هذا الجهاز لتستعد تدريجيًا."],
  ["Reset checklist", "Restablecer lista", "Réinitialiser la liste", "重設清單", "सूची रीसेट करें", "إعادة ضبط القائمة"],
  ["Official preparedness guidance", "Guía oficial de preparación", "Guide officiel de préparation", "官方應急準備指引", "आधिकारिक तैयारी मार्गदर्शन", "إرشادات الاستعداد الرسمية"],
  ["Emergency kit progress", "Progreso del kit de emergencia", "Progression du kit d’urgence", "應急用品準備進度", "आपातकालीन किट की प्रगति", "تقدم حقيبة الطوارئ"],
  ["ready", "listo", "prêt", "已準備", "तैयार", "جاهز"],
  ["Items collected", "Artículos reunidos", "Articles rassemblés", "已收集物品", "इकट्ठी वस्तुएँ", "العناصر المجمعة"],
  ["HOUSEHOLD PLAN", "PLAN DEL HOGAR", "PLAN DU FOYER", "家庭計劃", "घरेलू योजना", "خطة المنزل"],
  ["Size your basic supplies", "Calcula tus suministros básicos", "Dimensionnez vos fournitures de base", "計算基本物資數量", "बुनियादी आपूर्ति की मात्रा तय करें", "حدّد كمية المستلزمات الأساسية"],
  ["People in household", "Personas en el hogar", "Personnes dans le foyer", "家庭人數", "घर में लोग", "عدد أفراد المنزل"],
  ["Planning days", "Días de planificación", "Jours de préparation", "計劃日數", "तैयारी के दिन", "أيام التخطيط"],
  ["Water planning baseline", "Referencia de agua", "Base de planification de l’eau", "食水規劃基準", "पानी की योजना का आधार", "الكمية الأساسية للمياه"],
  ["About 3.8 L per person per day", "Aproximadamente 3,8 L por persona al día", "Environ 3,8 L par personne et par jour", "每人每日約 3.8 公升", "लगभग 3.8 लीटर प्रति व्यक्ति प्रति दिन", "نحو 3.8 لتر لكل شخص يوميًا"],
  ["CORE SUPPLIES", "SUMINISTROS ESENCIALES", "FOURNITURES ESSENTIELLES", "核心物資", "मुख्य आपूर्ति", "المستلزمات الأساسية"],
  ["Prepare category by category", "Prepárate categoría por categoría", "Préparez-vous catégorie par catégorie", "按類別逐項準備", "हर श्रेणी की तैयारी करें", "استعد فئةً بعد فئة"],
  ["Check each item when it is stored, usable and easy to reach. Review expiration dates regularly.", "Marca cada artículo cuando esté guardado, utilizable y accesible. Revisa regularmente las fechas de vencimiento.", "Cochez chaque article lorsqu’il est rangé, utilisable et accessible. Vérifiez régulièrement les dates de péremption.", "物品妥善存放、可用且易於取用後才剔選，並定期檢查有效日期。", "हर वस्तु सुरक्षित, उपयोग योग्य और आसानी से उपलब्ध होने पर चिह्नित करें। समाप्ति तिथियाँ नियमित रूप से जाँचें।", "حدّد كل عنصر بعد تخزينه والتأكد من صلاحيته وسهولة الوصول إليه. راجع تواريخ الانتهاء بانتظام."],
  ["Water & food", "Agua y alimentos", "Eau et nourriture", "食水及食物", "पानी और भोजन", "المياه والطعام"],
  ["Store safe drinking water and food that can be prepared without utilities.", "Almacena agua potable y alimentos que puedan prepararse sin servicios públicos.", "Stockez de l’eau potable et des aliments préparables sans services essentiels.", "儲備安全食水及毋須水電亦可準備的食物。", "सुरक्षित पेयजल और बिना उपयोगिता सेवाओं के तैयार होने वाला भोजन रखें।", "خزّن مياه شرب آمنة وطعامًا يمكن تحضيره دون خدمات."],
  ["Drinking water", "Agua potable", "Eau potable", "飲用水", "पीने का पानी", "مياه الشرب"],
  ["Non-perishable, easy-to-prepare food", "Alimentos no perecederos y fáciles de preparar", "Aliments non périssables et faciles à préparer", "不易腐壞且易於準備的食物", "न खराब होने वाला, आसानी से तैयार भोजन", "طعام غير قابل للتلف وسهل التحضير"],
  ["Manual can opener", "Abrelatas manual", "Ouvre-boîte manuel", "手動開罐器", "हाथ से चलने वाला कैन ओपनर", "فتاحة علب يدوية"],
  ["Reusable cups, plates and utensils", "Vasos, platos y utensilios reutilizables", "Gobelets, assiettes et couverts réutilisables", "可重用杯、碟及餐具", "दोबारा इस्तेमाल होने वाले कप, प्लेट और बर्तन", "أكواب وأطباق وأدوات قابلة لإعادة الاستخدام"],
  ["Health & hygiene", "Salud e higiene", "Santé et hygiène", "健康及衞生", "स्वास्थ्य और स्वच्छता", "الصحة والنظافة"],
  ["Prepare for injuries, routine health needs and limited sanitation.", "Prepárate para lesiones, necesidades médicas habituales y saneamiento limitado.", "Prévoyez les blessures, les besoins de santé courants et un assainissement limité.", "為受傷、日常健康需要及有限衞生條件作準備。", "चोट, नियमित स्वास्थ्य जरूरतों और सीमित स्वच्छता के लिए तैयार रहें।", "استعد للإصابات والاحتياجات الصحية المعتادة ومحدودية الصرف الصحي."],
  ["First aid kit", "Botiquín de primeros auxilios", "Trousse de premiers secours", "急救箱", "प्राथमिक चिकित्सा किट", "حقيبة إسعافات أولية"],
  ["Prescription medications and medical supplies", "Medicamentos recetados y suministros médicos", "Médicaments prescrits et fournitures médicales", "處方藥物及醫療用品", "पर्चे की दवाएँ और चिकित्सा सामग्री", "الأدوية الموصوفة والمستلزمات الطبية"],
  ["Sanitation and personal hygiene items", "Artículos sanitarios y de higiene personal", "Articles sanitaires et d’hygiène personnelle", "衞生及個人清潔用品", "स्वच्छता और व्यक्तिगत साफ-सफाई की वस्तुएँ", "مستلزمات الصرف الصحي والنظافة الشخصية"],
  ["Protective masks", "Mascarillas protectoras", "Masques de protection", "防護口罩", "सुरक्षात्मक मास्क", "كمامات واقية"],
  ["Light, power & communication", "Luz, energía y comunicación", "Éclairage, énergie et communication", "照明、電力及通訊", "रोशनी, बिजली और संचार", "الإضاءة والطاقة والاتصال"],
  ["Keep essential information and communication available during outages.", "Mantén disponibles la información y las comunicaciones esenciales durante los cortes.", "Maintenez l’accès aux informations et communications essentielles pendant les coupures.", "停電期間仍可取得重要資訊及維持通訊。", "बिजली बंद होने पर जरूरी जानकारी और संचार उपलब्ध रखें।", "حافظ على توفر المعلومات والاتصالات الأساسية أثناء الانقطاع."],
  ["Flashlights", "Linternas", "Lampes de poche", "電筒", "टॉर्च", "مصابيح يدوية"],
  ["Battery-powered or hand-crank radio", "Radio a pilas o de manivela", "Radio à piles ou à manivelle", "電池或手搖收音機", "बैटरी या हाथ से चलने वाला रेडियो", "راديو يعمل بالبطارية أو باليد"],
  ["Extra batteries and charged power banks", "Pilas adicionales y baterías externas cargadas", "Piles supplémentaires et batteries externes chargées", "後備電池及已充電流動電源", "अतिरिक्त बैटरियाँ और चार्ज पावर बैंक", "بطاريات إضافية وبنوك طاقة مشحونة"],
  ["Mobile phone chargers", "Cargadores de teléfono móvil", "Chargeurs de téléphone portable", "手提電話充電器", "मोबाइल फोन चार्जर", "شواحن الهواتف المحمولة"],
  ["Emergency whistle", "Silbato de emergencia", "Sifflet d’urgence", "緊急哨子", "आपातकालीन सीटी", "صافرة طوارئ"],
  ["Documents & money", "Documentos y dinero", "Documents et argent", "文件及金錢", "दस्तावेज और पैसे", "المستندات والمال"],
  ["Protect the information needed to identify, communicate and recover.", "Protege la información necesaria para identificarte, comunicarte y recuperarte.", "Protégez les informations nécessaires à l’identification, la communication et la reprise.", "妥善保護身份、通訊及災後復原所需資料。", "पहचान, संचार और पुनर्प्राप्ति के लिए जरूरी जानकारी सुरक्षित रखें।", "احمِ المعلومات اللازمة للتعريف والتواصل والتعافي."],
  ["Copies of identification, insurance and medical information", "Copias de identificación, seguros e información médica", "Copies des pièces d’identité, assurances et informations médicales", "身份、保險及醫療資料副本", "पहचान, बीमा और चिकित्सा जानकारी की प्रतियाँ", "نسخ من الهوية والتأمين والمعلومات الطبية"],
  ["Family and emergency contact information", "Información de contacto familiar y de emergencia", "Coordonnées familiales et d’urgence", "家庭及緊急聯絡資料", "परिवार और आपातकालीन संपर्क जानकारी", "معلومات اتصال العائلة والطوارئ"],
  ["Emergency cash in small denominations", "Efectivo de emergencia en billetes pequeños", "Argent liquide d’urgence en petites coupures", "小面額應急現金", "छोटे मूल्य में आपातकालीन नकद", "نقد للطوارئ بفئات صغيرة"],
  ["Local paper maps", "Mapas locales impresos", "Cartes locales papier", "本地紙本地圖", "स्थानीय कागजी नक्शे", "خرائط ورقية محلية"],
  ["Shelter, clothing & tools", "Refugio, ropa y herramientas", "Abri, vêtements et outils", "庇護、衣物及工具", "आश्रय, कपड़े और औजार", "المأوى والملابس والأدوات"],
  ["Include portable protection, practical tools and durable clothing.", "Incluye protección portátil, herramientas prácticas y ropa resistente.", "Ajoutez une protection portable, des outils pratiques et des vêtements résistants.", "準備便攜保護用品、實用工具及耐用衣物。", "पोर्टेबल सुरक्षा, उपयोगी औजार और टिकाऊ कपड़े रखें।", "أضف وسائل حماية محمولة وأدوات عملية وملابس متينة."],
  ["Emergency blankets or sleeping bags", "Mantas de emergencia o sacos de dormir", "Couvertures d’urgence ou sacs de couchage", "保暖氈或睡袋", "आपातकालीन कंबल या स्लीपिंग बैग", "بطانيات طوارئ أو أكياس نوم"],
  ["Seasonal clothing, rain gear and sturdy shoes", "Ropa de temporada, impermeables y calzado resistente", "Vêtements de saison, imperméables et chaussures solides", "合時衣物、雨具及堅固鞋履", "मौसमी कपड़े, वर्षा वस्त्र और मजबूत जूते", "ملابس موسمية وملابس مطر وأحذية متينة"],
  ["Multi-purpose tool", "Herramienta multiuso", "Outil multifonction", "多用途工具", "बहुउद्देश्यीय औजार", "أداة متعددة الاستخدامات"],
  ["Work gloves, duct tape and basic tools", "Guantes de trabajo, cinta adhesiva y herramientas básicas", "Gants de travail, ruban adhésif et outils de base", "工作手套、強力膠帶及基本工具", "काम के दस्ताने, डक्ट टेप और बुनियादी औजार", "قفازات عمل وشريط لاصق وأدوات أساسية"],
  ["Spare home and vehicle keys", "Llaves adicionales de casa y vehículo", "Clés de rechange du domicile et du véhicule", "後備家居及車輛鎖匙", "घर और वाहन की अतिरिक्त चाबियाँ", "مفاتيح احتياطية للمنزل والمركبة"],
  ["Personal & household needs", "Necesidades personales y del hogar", "Besoins personnels et du foyer", "個人及家庭需要", "व्यक्तिगत और घरेलू जरूरतें", "الاحتياجات الشخصية والمنزلية"],
  ["Adapt the kit for every person and animal in your household.", "Adapta el kit para cada persona y animal de tu hogar.", "Adaptez le kit à chaque personne et animal du foyer.", "按家中每位成員及寵物需要調整用品。", "घर के हर व्यक्ति और पशु के लिए किट को अनुकूल बनाएँ।", "كيّف الحقيبة لكل شخص وحيوان في منزلك."],
  ["Accessibility, mobility, hearing or vision supplies", "Suministros de accesibilidad, movilidad, audición o visión", "Fournitures d’accessibilité, mobilité, audition ou vision", "無障礙、行動、聽覺或視覺用品", "सुलभता, गतिशीलता, सुनने या देखने की सामग्री", "مستلزمات سهولة الوصول أو الحركة أو السمع أو البصر"],
  ["Infant, child or older-adult supplies", "Suministros para bebés, niños o adultos mayores", "Fournitures pour nourrissons, enfants ou personnes âgées", "嬰兒、兒童或長者用品", "शिशु, बच्चे या बुजुर्गों की सामग्री", "مستلزمات الرضع أو الأطفال أو كبار السن"],
  ["Pet food, water, medications, leash and carrier", "Alimento, agua, medicamentos, correa y transportador para mascotas", "Nourriture, eau, médicaments, laisse et cage pour animaux", "寵物食水、糧食、藥物、牽繩及運輸籠", "पालतू भोजन, पानी, दवाएँ, पट्टा और कैरियर", "طعام وماء وأدوية ومقود وحاملة للحيوانات"],
  ["Comfort items and activities for children", "Artículos de consuelo y actividades para niños", "Objets réconfortants et activités pour enfants", "兒童安撫用品及活動", "बच्चों के लिए आराम की वस्तुएँ और गतिविधियाँ", "أغراض للراحة وأنشطة للأطفال"],
  ["Clear category", "Desmarcar categoría", "Effacer la catégorie", "清除此類別", "श्रेणी साफ करें", "مسح الفئة"],
  ["Mark category complete", "Marcar categoría como completa", "Marquer la catégorie comme terminée", "標記此類別為完成", "श्रेणी पूरी चिह्नित करें", "تحديد الفئة كمكتملة"],
  ["Adapt this checklist to your household", "Adapta esta lista a tu hogar", "Adaptez cette liste à votre foyer", "按家庭需要調整此清單", "इस सूची को अपने घर के अनुसार ढालें", "كيّف هذه القائمة مع منزلك"],
  ["This educational checklist is a starting point, not emergency or medical advice. Add supplies for local hazards, climate, disabilities, prescriptions, infants, older adults and pets. Follow instructions from your local emergency authorities.", "Esta lista educativa es un punto de partida, no asesoramiento médico ni de emergencia. Añade suministros para riesgos locales, clima, discapacidades, recetas, bebés, adultos mayores y mascotas. Sigue las instrucciones de las autoridades locales.", "Cette liste pédagogique est un point de départ, pas un avis médical ou d’urgence. Ajoutez les fournitures adaptées aux risques locaux, au climat, aux handicaps, aux ordonnances, aux nourrissons, aux personnes âgées et aux animaux. Suivez les autorités locales.", "此教育清單只供起步參考，並非緊急或醫療建議。請按本地風險、氣候、殘疾需要、處方藥、嬰兒、長者及寵物增添物資，並遵從當地應急部門指示。", "यह शैक्षिक सूची शुरुआत के लिए है, आपातकालीन या चिकित्सा सलाह नहीं। स्थानीय जोखिम, मौसम, दिव्यांगता, पर्चे, शिशु, बुजुर्ग और पालतू जरूरतें जोड़ें। स्थानीय आपातकालीन अधिकारियों के निर्देश मानें।", "هذه القائمة التعليمية نقطة بداية وليست نصيحة طبية أو طارئة. أضف مستلزمات للمخاطر المحلية والمناخ والإعاقات والوصفات والرضع وكبار السن والحيوانات. اتبع تعليمات سلطات الطوارئ المحلية."],
  ...
  ["Open the SEISMIC repository on GitHub", "Abrir el repositorio de SEISMIC en GitHub", "Ouvrir le dépôt SEISMIC sur GitHub", "喺 GitHub 開啟 SEISMIC 程式碼庫", "GitHub पर SEISMIC रिपॉज़िटरी खोलें", "فتح مستودع SEISMIC على GitHub"],
  ["Embedded browser detected", "Navegador integrado detectado", "Navigateur intégré détecté", "偵測到內置瀏覽器", "एम्बेडेड ब्राउज़र मिला", "تم اكتشاف متصفح مضمّن"],
  ["PDFs will open in a viewer or share sheet. For the most reliable maps and downloads, use your browser menu to open SEISMIC in Safari or Chrome.", "Los PDF se abrirán en un visor o en la hoja para compartir. Para obtener mapas y descargas más confiables, usa el menú del navegador para abrir SEISMIC en Safari o Chrome.", "Les PDF s’ouvriront dans une visionneuse ou une feuille de partage. Pour des cartes et téléchargements plus fiables, utilisez le menu du navigateur pour ouvrir SEISMIC dans Safari ou Chrome.", "PDF 會喺檢視器或分享選單開啟。為確保地圖同下載最可靠，請用瀏覽器選單喺 Safari 或 Chrome 開啟 SEISMIC。", "PDF व्यूअर या शेयर शीट में खुलेगा। मानचित्र और डाउनलोड की बेहतर विश्वसनीयता के लिए ब्राउज़र मेनू से SEISMIC को Safari या Chrome में खोलें।", "ستُفتح ملفات PDF في عارض أو قائمة مشاركة. للحصول على خرائط وتنزيلات أكثر موثوقية، استخدم قائمة المتصفح لفتح SEISMIC في Safari أو Chrome."],
  ["Open SEISMIC in browser", "Abrir SEISMIC en el navegador", "Ouvrir SEISMIC dans le navigateur", "喺瀏覽器開啟 SEISMIC", "SEISMIC को ब्राउज़र में खोलें", "فتح SEISMIC في المتصفح"],
  ["The PDF could not be generated in this browser. Open the site in Safari or Chrome and try again.", "No se pudo generar el PDF en este navegador. Abre el sitio en Safari o Chrome e inténtalo de nuevo.", "Le PDF n’a pas pu être généré dans ce navigateur. Ouvrez le site dans Safari ou Chrome et réessayez.", "呢個瀏覽器無法產生 PDF。請喺 Safari 或 Chrome 開啟網站再試。", "इस ब्राउज़र में PDF नहीं बनाया जा सका। साइट को Safari या Chrome में खोलकर फिर प्रयास करें।", "تعذر إنشاء ملف PDF في هذا المتصفح. افتح الموقع في Safari أو Chrome ثم حاول مرة أخرى."],
  ["3D visualization is unavailable in this browser. The response metrics remain available below.", "La visualización 3D no está disponible en este navegador. Las métricas de respuesta siguen disponibles abajo.", "La visualisation 3D n’est pas disponible dans ce navigateur. Les mesures de réponse restent disponibles ci-dessous.", "呢個瀏覽器無法使用 3D 視覺化，下面仍可查看反應指標。", "इस ब्राउज़र में 3D दृश्य उपलब्ध नहीं है। प्रतिक्रिया मेट्रिक्स नीचे उपलब्ध हैं।", "العرض ثلاثي الأبعاد غير متاح في هذا المتصفح. تظل مقاييس الاستجابة متاحة أدناه."],
